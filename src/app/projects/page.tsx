...
export default function Projects() {
  const projects: Project[] = [
    ...
    },
    {
      ...
      description: 'Full website redesign and development Wordpress CMS, responsive design, and analytics tracking. Improved conversion rates and user experience across all devices.',
